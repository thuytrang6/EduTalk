...
class HomePage extends StatelessWidget {
  ...
  static const Color buttonOrangeEnd = Color(0xFFFF5D00);
  static const Color warmCardBg = Color(0xFFFFF9EE);
  static const Color warmBorder = Color(0xFFFFE58F);
  static const Color navyText = Color(0xFF001C3D);
  static const Color softText = Color(0xFF5A6B81);
